...
class savedRecipeCourse extends StatefulWidget {
  const savedRecipeCourse({Key? key}) : super(key: key);

  @override
  State<savedRecipeCourse> createState() => _savedRecipeCourseState();
}
...
class _savedRecipeCourseState extends State<savedRecipeCourse> {
  ...
  Widget _buildUserSavedRecipeCourse(double width) {
    return SizedBox(
      child: Query(
